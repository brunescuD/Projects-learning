...
validateCred(valid1);
*/
/** The role of findInvalidCards() is 
 * to check through the nested array for which numbers are invalid, 
...
function idInvalidCardCompanies(array){
    ...
    for(let cardNum of array){
        ...
        if(invalidCardMailers.indexOf(company)<0){
            invalidCardMailers.push(company);
        }
    }
    return invalidCardMailers;
}
